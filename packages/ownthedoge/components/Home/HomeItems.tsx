...
export const Doge = () => {
  ...
  return <div className={css("mx-6")}>
    ...
    <div className={css("mt-16", "px-16", "bg-pixels-yellow-100")}>
      <Link bold isExternal href={"https://knowyourmeme.com/memes/doge"}>Doge</Link> grew to <Link bold isExternal
                                                                                                   href={"https://knowyourmeme.com/editorials/meme-review/the-top-10-memes-of-the-decade"}>prominence</Link> in
      the
...
export const Pixels = () => {
  return <div>
    ...
    <div>
      <div className={css("text-base", "mt-4", "bg-pixels-yellow-100", "inline-block")}>(an actual pixel of The Doge
        NFT)
      </div>
    </div>
    <div className={css("mt-10", "bg-pixels-yellow-100")}>
      ...
      Pixel&apos; NFTs
      at the <Link bold isExternal href={"https://pixels.ownthedoge.com"}>Doge Pixel Portal</Link>. Doge Pixel holders
      get access to
      monthly perks, mints, and drops known as <Link bold isExternal href={"https://pixels.ownthedoge.com/perks"}>Pixel
      Perks</Link>.
    </div>
  </div>
}
