  ...
  return (
    <PageLayout>
      ...
      <div className={css("flex", "gap-5", "flex-col", "mb-28")}>
        ...
        <div
          className={css("flex", "flex-col", "justify-center", "items-center")}
        >
          <div
            className={css(
              "text-center",
          ...
          >
            Backed by the DOG Community Fund, the Bark Tank acts as an incubator
            for any and all Doge related projects. Pitch your idea and get
            funded today!
          </div>
